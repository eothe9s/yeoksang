...
globalThis.y211ShowRecovery=function(message){
 ...
 const title=document.createElement('h2');title.textContent='기록 보호 · 曆象 2.4';
 const p=document.createElement('p');p.textContent=message+' Safari 웹사이트 데이터를 지우지 마세요.';
 const a=document.createElement('a');a.href='./recovery.html?v=2400';a.textContent='기존 저장값 원본 내보내기';a.style.cssText='display:block;padding:20px 0';
