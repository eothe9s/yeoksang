...
globalThis.y211ShowRecovery=function(message){
 ...
 const title=document.createElement('h2');title.id='recoveryHeading';title.textContent='기록 보호 · 曆象 2.5';
 ...
 const link=document.createElement('a');link.href='./recovery.html?v=2500';link.textContent='별도 원본 복구 화면';
