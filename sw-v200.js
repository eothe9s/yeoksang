const VERSION='2.5.1';
const CACHE='yeoksang-v2-5-1-widget-live-history-20260923';
const ASSETS=['./index.html?v=251-history-1','./boot-v220.js?v=2501','./recovery.html?v=2501','./styles-v200.css?v=2501','./styles-v210.css?v=2501','./styles-v240.css?v=2501','./app-v200-core.js?v=251-history-1','./app-v200-engine.js?v=2501','./app-v200-recovery.js?v=2501','./app-v210.js?v=2501','./app-v220-analysis.js?v=2501','./app-v230.js?v=2501','./app-v231.js?v=2501','./app-v240.js?v=251-history-1','./app-widget-live.js?v=251-live-1','./record-safety.js?v=2501','./view-tools.js?v=2501','./manifest-v200.webmanifest?v=2501','./icon-192.png','./icon-512.png'];
...
self.addEventListener('fetch',event=>{
 ...
 event.respondWith((async()=>{
  ...
  if(event.request.mode==='navigate'&&!url.pathname.endsWith('recovery.html')){
   const page=await cache.match('./index.html?v=251-history-1');if(page)return page;
  }
